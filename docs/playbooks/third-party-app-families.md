...
Playbooks are views over the shared ontology in `docs/ontology/macos-vulnerability-classes.md`. Start by inventorying the bundle or binary, derive one or more family labels from observed surfaces, then map those surfaces to ontology classes and record the pass in the copied findings repo.
...
7. Run applicable Ghidra or metadata sweeps.
